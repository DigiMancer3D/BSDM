...
A Star Wars-inspired, 3D-styled "Lights Out" puzzle game for Flipper Zero!  
The evil Flipper Zero, Sith Lord, is trying to keep all the lights on.  
You, the Jedi, must vanquish the darkness by turning off every light on the grid.
...
- **D-pad:** Move cursor
- **OK:** Select a tile (your move), advance text, or select menu option
- **In Lost menu:** Up/Down/Left/Right to change selection, OK to choose Yes/No

### Hidden Credits Sequence

- Tap "right" quickly 3 more times.
- The game will fade out, play the animated credits, then return you to play with Flipper!
